...
<div class="min-h-screen bg-stone-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-3xl font-display text-stone-900">Create New Article</h1>
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-stone-200">
            <div class="p-8">
                ...
                <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" 
                                  class="mt-1 block w-full rounded-md border-stone-300 shadow-sm focus:border-amber-500 focus:ring-amber-500 sm:text-sm border p-2">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" class="min-h-[400px]">{{ old('content') }}</textarea>
                    </div>
...
<script>
    tinymce.init({
        ...
        images_upload_path: '/upload-image', // Note: Check your controller endpoint
        // Automatic upload handling might need extra config for Laravel CSRF
    });
</script>
@endsection
